...
public class MailService {
    ...
    private void sendEmail(String to, String subject, String value, MailType mailType) {
    ...
    @Async
    public void sendEmailAsync(String to, String subject, String value, MailType mailType) {
