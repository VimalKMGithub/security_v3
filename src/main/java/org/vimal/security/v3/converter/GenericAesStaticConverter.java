...
@Component
public class GenericAesStaticConverter {
    private final AesStaticUtility aesStaticUtility;

    public GenericAesStaticConverter(PropertiesConfig propertiesConfig, ObjectMapper objectMapper) throws NoSuchAlgorithmException {
